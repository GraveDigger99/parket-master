(() => {
            ...
            function setSpollerAction(e) {
                ...
                if (el.closest("[data-spoller]")) {
                    ...
                    if (!spollersBlock.querySelectorAll("._slide").length) {
                        ...
                        document.documentElement.classList.add("_spoller-active");
    ...
    function initSliders() {
        if (document.querySelector(".images-our-work__thumbs")) {
            const thumbsSwiper = new core(".images-our-work__thumbs", {
                slidesPerView: 4,
                modules: [ Thumb ],
                observer: true,
                observeParents: true,
            ...
            new core(".images-our-work__slider", {
                slidesPerView: 1,
                spaceBetween: 30,
    ...
    da.init();
    const premiumText = document.querySelector(".card-tariff__text_premium");
    const economyValue = document.querySelector(".card-tariff__value_economy");
    if (premiumText) if (window.innerWidth < 1132) premiumText.innerHTML = "Базовый комплекс работ + <span>3-х разовое покрытие лаком</span>";
    if (economyValue) if (window.innerWidth < 1132) economyValue.innerHTML = "180";
    window["FLS"] = false;
    isWebp();
    menuInit();
    spollers();
